...
export class InitMigration1751711165739 implements MigrationInterface {
    name = 'InitMigration1751711165739'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "doctor_availability" ADD "consulting_start_time" character varying NOT NULL DEFAULT '09:00'`);
