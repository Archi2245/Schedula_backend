...
export class InitMigration1751959241357 implements MigrationInterface {
    name = 'InitMigration1751959241357'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "appointment" ADD "timeSlotSlotId" integer NOT NULL`);
