...
export class InitMigration1751711983118 implements MigrationInterface {
    name = 'InitMigration1751711983118'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "doctor_availability" ADD "consulting_start_time" character varying DEFAULT '09:00'`);
        await queryRunner.query(`ALTER TABLE "doctor_availability" ADD "consulting_end_time" character varying DEFAULT '11:00'`);
        ...
        await queryRunner.query(`ALTER TABLE "doctor_availability" ADD "current_bookings" integer DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "doctor_availability" ADD "is_fully_booked" boolean DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "doctor_availability" ALTER COLUMN "slot_bookings" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "doctor_availability" ALTER COLUMN "slot_bookings" SET NOT NULL`);
